...
from .robrosIgrisA import RobrosIgrisA


class MjxRobrosIgrisA(RobrosIgrisA):
    ...
    def _modify_spec_for_mjx(self, spec: MjSpec):
        ...
        spec.add_pair(geomname1="floor", geomname2="right_foot")
        spec.add_pair(geomname1="floor", geomname2="left_foot")
        spec.add_pair(geomname1="right_foot", geomname2="left_foot")
