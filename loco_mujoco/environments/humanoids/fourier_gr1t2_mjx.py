...
class MjxFourierGR1T2(FourierGR1T2):
    ...
    def _modify_spec_for_mjx(self, spec: MjSpec):
        ...
        spec.add_pair(geomname1="floor", geomname2="l_foot_1")
        spec.add_pair(geomname1="floor", geomname2="l_foot_2")
        spec.add_pair(geomname1="floor", geomname2="r_foot_1")
        spec.add_pair(geomname1="floor", geomname2="r_foot_2")
